...
import static zlc.season.rxdownload2.entity.DownloadFlag.INSTALLED;
...
public class DownloadEventFactory {
    ...
    public static DownloadEvent installed(DownloadStatus status){
        return createEvent(INSTALLED, status);
    }
