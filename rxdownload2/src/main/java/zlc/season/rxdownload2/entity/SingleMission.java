        ...
        disposable = rxdownload.download(bean)
                ...
                .subscribe(new Consumer<DownloadStatus>() {
                    ...
                    public void accept(Throwable throwable) throws Exception {
                        ...
                        SingleMission.this.pause(DataBaseHelper.getSingleton());
//// FIXME: 17/4/5
...
//                        }
    ...
    @Override
    public void installed(DataBaseHelper dataBaseHelper) {

        if (processor != null && isCompleted()) {
            processor.onNext(DownloadEventFactory.installed(dataBaseHelper.readStatus(getUrl())));
        }
    }
