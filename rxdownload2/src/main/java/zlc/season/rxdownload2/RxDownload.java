...
public class RxDownload {
    ...
    public Observable<DownloadEvent> receiveDownloadStatus(final DownloadBean bean) {
        return createGeneralObservable(null)
                .flatMap(new Function<Object, ObservableSource<DownloadEvent>>() {
                    @Override
                    public ObservableSource<DownloadEvent> apply(Object o) throws Exception {
                        Utils.log("downloadService=" + downloadService);
                        return downloadService.receiveDownloadEvent(bean).toObservable();
                    }
                })
                .observeOn(AndroidSchedulers.mainThread());
    }

    public Flowable<DownloadEvent> receiveDownloadStatusFlowable(final DownloadBean bean) {
        return createGeneralFlowable(null)
                .flatMap(new Function<Object, Publisher<DownloadEvent>>() {
                    ...
                    public Publisher<DownloadEvent> apply(@NonNull Object o) throws Exception {
                        Utils.log("receiveDownloadStatusFlowable.downloadService=" + downloadService);

//                        if (downloadService != null){
                            return downloadService.receiveDownloadEvent(bean);
//                        }
//                        Utils.log("receiveDownloadStatusFlowable.downloadService.null=" + downloadService);
//                        return new Publisher<DownloadEvent>(){
//
//                            @Override
//                            public void subscribe(Subscriber<? super DownloadEvent> s) {
//                                s.onNext(DownloadEventFactory.normal(null));
//                                s.onComplete();
//                            }
//                        };
                    }
