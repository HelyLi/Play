...
import static zlc.season.rxdownload2.db.Db.RecordTable.COLUMN_APK_NAME;
import static zlc.season.rxdownload2.db.Db.RecordTable.COLUMN_IS_WIFI;
import static zlc.season.rxdownload2.db.Db.RecordTable.COLUMN_PACKAGE_NAME;
import static zlc.season.rxdownload2.db.Db.RecordTable.COLUMN_SIZE;
import static zlc.season.rxdownload2.db.Db.RecordTable.COLUMN_GAME_ID;
...
import static zlc.season.rxdownload2.db.Db.RecordTable.COLUMN_PIC_URL;
        ...
        try {
            cursor = getReadableDatabase().query(TABLE_NAME,
                    new String[]{COLUMN_ID, COLUMN_URL, COLUMN_SAVE_NAME, COLUMN_SAVE_PATH,
                            ...
                            COLUMN_PIC_URL, COLUMN_APK_NAME, COLUMN_PACKAGE_NAME, COLUMN_SIZE,
                            COLUMN_GAME_ID, COLUMN_IS_WIFI, COLUMN_DOWNLOAD_FLAG, COLUMN_DATE, COLUMN_MISSION_ID},
                    COLUMN_URL + "=?", new String[]{url}, null, null, null);
            cursor.moveToFirst();
