...
class DayView extends CheckedTextView {
    ...
    private static final int[] STATE_PAST = {R.attr.state_past};

    private boolean mStatePast = true;
    ...
    protected int[] onCreateDrawableState(int extraSpace) {
        if (mStatePast) {
            ...
            mergeDrawableStates(drawableState, STATE_PAST);
