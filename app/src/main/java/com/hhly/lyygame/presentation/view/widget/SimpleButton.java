...
public class SimpleButton extends View {
    ...
    private void _init(Context context, AttributeSet attrs) {
        mBorderWidth = DisplayUtil.dip2px(context, 0.5f);
        mRadius = DisplayUtil.dip2px(context, 5f);
        mHorizontalPadding = (int) DisplayUtil.dip2px(context, 5f);
        mVerticalPadding = (int) DisplayUtil.dip2px(context, 5f);
        mIconPadding = (int) DisplayUtil.dip2px(context, 3f);
        mTextSize = DisplayUtil.sp2px(context, 14f);
