...
public class MenuTwoDivide extends RecyclerView.ItemDecoration {
    ...
    public MenuTwoDivide(Context context) {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        MenuTwoAdapter adapter = (MenuTwoAdapter) parent.getAdapter();
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (adapter instanceof MenuTwoAdapter) {
            MenuTwoAdapter menuAdapter = (MenuTwoAdapter) adapter;
